...
- [Pelican Panel](https://pelican.dev), a game server management panel. Available as [services.pelican-panel](#opt-services.pelican-panel.enable) and [services.pelican-wings](#opt-services.pelican-wings.enable) (for the control plane).
